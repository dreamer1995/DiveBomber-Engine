...
namespace DiveBomber::DX
{
	...
	public:
		...
		[[nodiscard]] std::shared_ptr<GraphicResource::RenderTarget> GetCurrentBackBuffer() noexcept;
	...
	private:
		...
		std::shared_ptr<GraphicResource::RenderTarget> backBuffers[SwapChainBufferCount];
