...
namespace DiveBomber::GraphicResource
{
	...
	public:
		...
		IndexedTriangleList(VertexProcess::VertexData verts_in, std::vector<unsigned short> indices_in)
			:
		...
		{
			using Elements = VertexProcess::VertexLayout::ElementType;
	...
	public:
		VertexProcess::VertexData vertices;
