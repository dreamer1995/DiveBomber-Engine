...
namespace DiveBomber::GraphicResource
{
	...
	void DiveBomber::GraphicResource::PipelineStateObject::UpdatePipelineState(const PipelineStateReference inputPipelineStateReference)
	{
		pipelineStateReference = inputPipelineStateReference;
		UpdatePipelineState();
	}

	void DiveBomber::GraphicResource::PipelineStateObject::UpdatePipelineState()
	{
		HRESULT hr;
