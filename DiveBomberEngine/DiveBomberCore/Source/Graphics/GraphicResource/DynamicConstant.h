...
namespace DiveBomber::GraphicResource::DynamicConstantProcess
{
...
#define LEAF_ELEMENT_TYPES \
	...
	{
	public:
		static DynamicConstantProcess::CookedLayout Resolve(DynamicConstantProcess::RawLayout&& layout) noxnd;
	private:
		static LayoutCodex& Get_() noexcept;
		std::unordered_map<std::string, std::shared_ptr<DynamicConstantProcess::LayoutElement>> map;
	};
